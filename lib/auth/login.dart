...
import 'package:partner_foodbnb/auth/forget_password.dart';
import 'package:partner_foodbnb/auth/register.dart';
import 'package:partner_foodbnb/screens/home_screen.dart';
...
class _LoginState extends State<Login> {
  // Define Controllers and Loading state
  ...
  Future<void> _handleLogin() async {
    ...
    on FirebaseAuthException catch (e) {
      ...
      if (e.code == 'invalid-email') errorMessage = "The email address is badly formatted.";
            ...
            children: [
              ...
              Center(
                child: CircleAvatar(
                  ...
                  child: Icon(Icons.restaurant_menu, color: primaryRed, size: 36),
                ),
              ),
